...
struct DateHelper {
    ...
    static func getShortDateFromString(_ dateStr: String) -> Date? {
        let dateFormater = DateFormatter()
    ...
    /// Get iso date string from date object
    static func getStringFromShortDate(_ date: Date) -> String? {
        let dateFormater = DateFormatter()
        dateFormater.dateFormat = "dd MMM"
        return dateFormater.string(from: date)
    }
    ...
    static func getMonthStringFromShortDate(_ date: Date) -> String? {
        let dateFormater = DateFormatter()
        dateFormater.dateFormat = "MM"
        return dateFormater.string(from: date)
    }
    
    static func getYearStringFromShortDate(_ date: Date) -> String? {
        let dateFormater = DateFormatter()
