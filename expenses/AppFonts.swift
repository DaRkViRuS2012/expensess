...
struct AppFonts {
    // MARK: fonts names
    private static let fontNameBoldEN = "OpenSansBold"
    private static let fontNameBoldAR = "DroidArabicKufiBold"
    private static let fontNameSemiBoldEN = "OpenSansSemiBold"
    private static let fontNameSemiBoldAR = "DroidArabicKufi"
    private static let fontNameRegularEN = "OpenSansRegular"
